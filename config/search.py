...
search_terms = [
    ...
    "Business Operations", "Operations Executive", "Data Specialist",
    "Research Analyst", "Financial Analyst",
    "MIS Reporting", "Data Entry", "MIS Executive", "Data Entry Operator",
]
...
current_experience = -1            # -1 = apply to ALL jobs regardless of experience required
##
